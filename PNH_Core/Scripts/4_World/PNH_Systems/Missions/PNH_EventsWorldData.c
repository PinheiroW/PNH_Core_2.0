...
class PNH_EventsWorldData
{
    ...
    static void Init()
    {
		...
		//282
		MissionEvents.Insert("CityStore Berezino central Dolina");							MissionPositions.Insert("12029.0 55.4 9161.8");
		MissionEvents.Insert("CityStore Berezino central Krasnostav");						MissionPositions.Insert("12029.0 55.4 9161.8");
		MissionEvents.Insert("CityStore Berezino central Staroye");							MissionPositions.Insert("12029.0 55.4 9161.8");
		MissionEvents.Insert("CityStore Elektrozavodsk central Dolina");						MissionPositions.Insert("10423.1 7.4 2364.9");
		MissionEvents.Insert("CityStore Elektrozavodsk central Kamyshovo");					MissionPositions.Insert("10423.1 7.4 2364.9");
		MissionEvents.Insert("CityStore Elektrozavodsk central Novoselki");					MissionPositions.Insert("10423.1 7.4 2364.9");
		MissionEvents.Insert("CityStore Elektrozavodsk central Staroye");					MissionPositions.Insert("10423.1 7.4 2364.9");
		MissionEvents.Insert("CityStore Kamenka northwest Komarovo");						MissionPositions.Insert("1135.6 7.1 2429.6");
		MissionEvents.Insert("CityStore Kamenka northwest Nadezhdino");						MissionPositions.Insert("1135.6 7.1 2429.6");
		MissionEvents.Insert("CityStore Kamenka northwest Novoselki");						MissionPositions.Insert("1135.6 7.1 2429.6");
		MissionEvents.Insert("CityStore Krasnostav central Gorka");							MissionPositions.Insert("11130.4 200.4 12283.9");
		MissionEvents.Insert("CityStore Novodmitrovsk central Berezino");					MissionPositions.Insert("11837.3 34.7 14351.3");
		MissionEvents.Insert("CityStore Novodmitrovsk central Krasnostav");					MissionPositions.Insert("11837.3 34.7 14351.3");
		MissionEvents.Insert("CityStore Polana central Novy_Sobor");							MissionPositions.Insert("10684.2 212.4 8022.8");
		MissionEvents.Insert("CityStore Polana central Kamyshovo");							MissionPositions.Insert("10684.2 212.4 8022.8");
		MissionEvents.Insert("CityStore Polana central Krasnostav");							MissionPositions.Insert("10684.2 212.4 8022.8");
		MissionEvents.Insert("CityStore Polana central Staroye");							MissionPositions.Insert("10684.2 212.4 8022.8");
		MissionEvents.Insert("CityStore Pustoshka central Grishino");						MissionPositions.Insert("3058.4 305.3 7978.0");
		MissionEvents.Insert("CityStore Pustoshka central Nadezhdino");						MissionPositions.Insert("3058.4 305.3 7978.0");
		MissionEvents.Insert("CityStore Pustoshka central Novy_Sobor");						MissionPositions.Insert("3058.4 305.3 7978.0");
		MissionEvents.Insert("CityStore Stary_Sobor central Gorka");							MissionPositions.Insert("6054.3 302.2 7849.7");
		MissionEvents.Insert("CityStore Stary_Sobor central Nadezhdino");					MissionPositions.Insert("6054.3 302.2 7849.7");
		MissionEvents.Insert("CityStore Svergino central Berezino");							MissionPositions.Insert("9549.7 85.4 13668.2");
		MissionEvents.Insert("CityStore Svergino central Grishino");							MissionPositions.Insert("9549.7 85.4 13668.2");
		MissionEvents.Insert("CityStore Svergino central Gorka");							MissionPositions.Insert("9549.7 85.4 13668.2");
		MissionEvents.Insert("CityStore Vybor central Grishino");							MissionPositions.Insert("3831.2 312.5 8875.4");
		MissionEvents.Insert("CityStore Vybor central Nadezhdino");							MissionPositions.Insert("3831.2 312.5 8875.4");
		MissionEvents.Insert("CityStore Vybor central Novaya_Petrovka");						MissionPositions.Insert("3831.2 312.5 8875.4");
		MissionEvents.Insert("CityStore Vybor central Novy_Sobor");							MissionPositions.Insert("3831.2 312.5 8875.4");
		//311
		...
		//693
        // --- ADICIONE A NOSSA NOVA MISSÃO AQUI ---
        MissionEvents.Insert("Transport Vybor to Altar");        							 MissionPositions.Insert("4202.205078 324.457031 8963.421875");
        //784
    ...
    } // <--- ESTA CHAVETA FECHA A FUNÇÃO Init()

    // A nossa função de segurança anti-crash
    static bool GetBuildingsAtLoc(string bldName, string desc, out array<vector> posList)
    {
        if (!posList)
        {
            posList = new array<vector>;
        }
        return false; 
    }

} // <--- ESTA CHAVETA FECHA A CLASSE E É A ÚLTIMA LINHA DO FICHEIRO
class GraveyardMission extends SurvivorMissions
{
	...
	void GraveyardMission()
	{
		...
		m_MissionMessage1 = "Acabei de receber que o comandante do Major General Troups de Defesa de Chernarus "+ SurvivorName +" não sobreviveu à infecção.";
		m_MissionMessage2 = "Ele era um dos oficiais do Exército Soviético em Chernarus. "+ SurvivorName +" me disse que perdeu mais de 2.000 homens aqui e nunca desistirá de lutar contra a infecção enquanto viver. Ele foi infectado enquanto protegia residentes de "+ m_MissionLocation +".";
		m_MissionMessage3 = "Ele escondeu alguns equipamentos no cemitério de\n** "+ m_MissionLocation +", "+ m_MissionLocationDir +" perto da igreja **\nAcho que alguém deveria pegar seu legado. Ele enterrou em qualquer lugar perto dos túmulos. Você precisa de pelo menos uma pá. Tome cuidado!";

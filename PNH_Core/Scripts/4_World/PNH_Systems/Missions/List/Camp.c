class CampMission extends SurvivorMissions
{
	...
	void CampMission()
	{
        ...
        m_MissionMessage1 = "Minha amiga "+ SurvivorName +" não respondeu no rádio nas últimas 2 horas. Ele é um excelente sobrevivente ao ar livre e estou me perguntando se ele está bem.";
        m_MissionMessage2 = "A filha dele está infectada, Ele cuida dela às vezes. Cerca de 5 horas atrás, ele me disse que encontrou coisas em algumas casas de "+ m_MissionLocation +" e foi atacado no caminho de volta ao acampamento, mas não ficou ferido.";
        m_MissionMessage3 = "Eu acho que ele disse que recentemente armou sua barraca\n "+ m_MissionLocationDir +" do "+ m_MissionLocation +" \nEstou muito preocupada, ficaria muito grata se você pudesse ir cuidar dele. Cuidado, ele usa armadilhas para proteger seu lugar!";		

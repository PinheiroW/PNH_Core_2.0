class CityMallMission extends SurvivorMissions
{
	...
	{		
		...
		m_MissionMessage3 = "Ela precisa imediatamente das coisas do mercado:\n- "+ ReqFoodAmount +" latas de comida e ..\n- "+ ReqMedAmount +" pacotes de antibióticos \nPor favor, ajude-me a apoiar a Sra. "+ SurvivorName +" com aqueles itens fundamentais de vida para as crianças.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage2 = "Acho que o melhor seria se você pudesse depositar os suprimentos na sala silenciosa do pequeno\n** "+ m_MissionDescription[3] +" ** delegacia e coloquei tudo na mochila laranja que deixei lá. Vou checar em uma hora e tentar contatá-la pelo rádio.";
		m_MissionMessage3 = "Tenho algumas coisas para você na pequena delegacia. Tenha cuidado, pode haver bandidos por perto "+ m_MissionDescription[3] +". Eles poderiam interceptar nossa pequena conversa de rádio aqui. Boa sorte!";

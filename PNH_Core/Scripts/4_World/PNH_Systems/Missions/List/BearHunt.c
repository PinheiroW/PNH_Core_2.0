class BearHuntMission extends SurvivorMissions
{
	...
	{	
		...
		m_MissionMessage1 = "Um sobrevivente relatou recentemente para mim que um urso atacou meu amigo "+ SurvivorName +" e matou 2 outros sobreviventes. Eles foram para o local errado tentando caçar alguns cervos na floresta de "+ m_MissionLocation +".";
		m_MissionMessage2 = "Ainda não consigo acreditar. "+ SurvivorName +" era um dos melhores caçadores por aqui. Uma vez por semana, ele trazia carne fresca para o acampamento escondido para alimentar os sobreviventes. Ele nunca foi altruísta e tentou fazer de tudo para ajudar no acampamento.";
		m_MissionMessage3 = "O urso foi relatado pela última vez na floresta perto\n** "+ m_MissionLocationDir +" do "+ m_MissionLocation +" **\nEu quero que você mate este animal e pegue sua pele. Não é por vingança, só precisamos da pele para fazer roupas de inverno para as crianças. Tome cuidado!";
	...
	void ExtendMission()
	{
		...
		m_MissionMessage1 = "Tudo bem sobrevivente, você encontrou a localização do urso. Tente envolvê-lo com segurança e matá-lo mirando em sua cabeça ou coração. Um urso é um animal forte, então vai precisar de alguns tiros para derrubá-lo.";
		m_MissionMessage2 = "Pegue sua faca e eviscerá-lo. Traga a pele e a carne para o\n** "+ m_MissionDescription[3] +" Sala de aula de laboratório escolar **\n(left wing, top floor) porque quero examinar a carne de urso. Deixei uma sacola de caça na mesa de trabalho.";
		m_MissionMessage3 = "Coloque pelo menos "+ ReqMeatAmount +" bifes de urso e a pele lá dentro. Tenha cuidado, pode haver bandidos por perto que possam interceptar nossa pequena conversa de rádio aqui. Boa sorte!";

class FreePigsMission extends SurvivorMissions
{
	...
	{		
		...
		m_MissionMessage1 = SurvivorName +", um fazendeiro de "+ m_MissionLocation +", morreu há 2 dias após um ataque de bandidos. Ele estava protegendo seus animais de infectados e necrófagos e criava porcos para entregar carne aos jovens e velhos sobreviventes, escondidos em algum lugar nas florestas.";
		m_MissionMessage2 = "Ele era bem conhecido entre os sobreviventes por sua perfeição em fazer bom bacon e carne temperada para churrasco. Seus porcos ainda estão no galpão e temo que eles possam morrer de fome, se já não estiverem mortos por infectados ou roubados por bandidos.";
		m_MissionMessage3 = "Vamos para "+ SurvivorName +"'s fazenda localizada \n** "+ m_MissionLocationDir +" do "+ m_MissionLocation +" **\ne libertar todos os porcos de sua gaiola para dar-lhes uma chance de sobreviver. Você precisa de pelo menos uma faca.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Tudo bem, você encontrou os porcos. Reúna todos eles para fora do galpão. Proteja-os de ataques infectados e mate 2 porcos para conseguir um pouco de carne.";
		m_MissionMessage2 = "Um homem do campo de sobreviventes disse que poderia ir para uma posição de salvamento em qualquer lugar da floresta e conseguir a carne. Deixei uma sacola de caça na mesa de piquenique na trilha de caminhada.";
		m_MissionMessage3 = "Traga a carne para a mesa de piquenique perto\n** "+ m_MissionDescription[3] +", coordenadas: "+ Coords +" **\nPor "+ ReqMeatAmount +" bifes de porco dentro dela e então você pode levar o que precisa. Tome cuidado!";

...
{	//CityStore is a copy of UrbanMall mission, it uses another secondary mission building
	...
	{		
		...
		m_MissionMessage1 = "Sra. "+ SurvivorName +", uma professora de escola infantil, disse que trouxe alguns alunos de sua classe em segurança de suas famílias infectadas. Prometi que a ajudaria a conseguir comida e outros suprimentos médicos para as crianças.";
		...
		m_MissionMessage3 = "Ela precisa imediatamente das coisas do loja:\n- "+ ReqFoodAmount +" latas de comida\n- "+ ReqMedAmount +" pacotes de antibióticos\nPor favor, ajude-me a apoiar a Sra. "+ SurvivorName +" com esses itens fundamentais de vida para as crianças. Tome cuidado!";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Tudo bem, você encontrou os suprimentos, tente chegar lá com segurança. Sra. "+ SurvivorName +" nunca me disse seu paradeiro porque ela quer estar absolutamente segura de bandidos e necrófagos.";
		m_MissionMessage2 = "Acho que o melhor seria se você pudesse depositar os suprimentos na sala silenciosa do pequeno\n** "+ m_MissionSecondaryLoc +" ** delegacia e coloque tudo na mochila laranja que deixei lá. Vou checar em uma hora e tentar contatá-la pelo rádio.";
		m_MissionMessage3 = "Tenho algumas coisas para você na pequena delegacia. Tenha cuidado, pode haver bandidos por perto "+ m_MissionSecondaryLoc +". Eles poderiam interceptar nossa pequena conversa de rádio aqui. Boa sorte!";

...
{	//UrbanMall is a copy of CityMall mission, it has equal functionality but uses different MissionBuilding 
	...
	{		
		...
		m_MissionMessage1 = "Sra. "+ SurvivorName +", uma professora de escola infantil, disse que trouxe alguns alunos da sua classe em segurança de suas famílias infectadas. Prometi que a ajudaria a conseguir comida e outros suprimentos médicos para as crianças.";
		m_MissionMessage2 = "Ontem descobri que o shopping da cidade de\n** "+ m_MissionLocation +" **\nestá bloqueado e provavelmente tem alguma comida dentro. Mas havia muitos infectados por aí, não consegui checar no Supermercado.";
		m_MissionMessage3 = "Ela precisa imediatamente das coisas do shopping:\n- "+ ReqFoodAmount +" latas de comida\n- "+ ReqMedAmount +" pacotes de antibióticos\nPor favor, ajude-me a apoiar a Sra. "+ SurvivorName +" com esses itens fundamentais para as crianças. Tome cuidado!";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Tudo bem, você encontrou os suprimentos, tente chegar lá com segurança. Em. "+ SurvivorName +" nunca me disse seu paradeiro porque ela quer estar absolutamente segura de bandidos e necrófagos.";
		m_MissionMessage2 = "Acho que o melhor será se você puder depositar os suprimentos no refeitório do\n** "+ m_MissionDescription[3] +" **  polícia e coloquei tudo na mochila laranja que deixei lá. Vou checar em uma hora e tentar contatá-la pelo rádio.";
		m_MissionMessage3 = "Vou te dar um lockpick, tentar chegar à sala do arsenal e trancá-la. Tudo está aí. Tenha cuidado, pode haver bandidos por perto "+ m_MissionDescription[3] +". Eles poderiam interceptar nossa pequena conversa de rádio aqui. Boa sorte!";

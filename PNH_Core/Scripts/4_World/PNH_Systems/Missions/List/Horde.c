class HordeMission extends SurvivorMissions
{
	...
	void HordeMission()
	{
		...
		m_MissionMessage1 = "Recebi uma chamada de emergência de um piloto de helicóptero que caiu em algum lugar da floresta. Ele está ferido, mas ainda está vivo. Ele temia que os infectados o encontrassem em breve.";
		m_MissionMessage2 = "Ele o empregou em uma casa em um vilarejo perto do local do acidente. Ele está bem equipado e acha que vai ficar em casa durante a noite, onde trata de suas feridas abertas.";
		m_MissionMessage3 = "A casa está no ** "+ m_MissionLocationDir +" lado "+ m_MissionLocation +" **\nTenha cuidado, pois pode haver infectados e outros sobreviventes que querem seu equipamento!";

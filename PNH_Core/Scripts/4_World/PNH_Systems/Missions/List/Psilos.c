class PsilosMission extends SurvivorMissions
{
	...
	void ExtendMission()
	{
		...
		m_MissionMessage2 = "Traga-os para o ** "+ m_MissionDescription[3] +" Delegacia de polícia **\n"+ SurvivorExtName +" disse que ela poderia extrair a substância ativa para mim. Ela deixou uma pequena caixa protetora sobre a mesa do escritório.";

class ShroomsMission extends SurvivorMissions
{
	...
	{	
		...
		m_MissionMessage1 = SurvivorName +", um sobrevivente que conheci há poucos dias me disse que existem alguns lugares por aqui com inúmeras ocorrências de um cogumelo especial. Seu nome de classificação é 'Psilocybe semilanceata'.";
		m_MissionMessage2 = "No momento, estou fazendo experiências com a substância psicoativa que contém Psilocibina em animais selvagens infectados. Os animais apresentam comportamentos interessantes após 30 minutos da ingestão oral. Ainda não posso falar muito sobre isso, mas para meus experimentos preciso de mais cogumelos.";
		m_MissionMessage3 = SurvivorName +" disse que encontrou alguns desses em qualquer lugar\n** "+ m_MissionLocationDir +" do "+ m_MissionLocation +" **\neu preciso de "+ ReqShroomsCount +" mais pedaços dele. Os cogumelos são muito pequenos. Eu recomendo usar uma enciclopédia de cogumelos para possíveis ocorrências!";
	...
	void ExtendMission()
	{
		...
		m_MissionMessage1 = "Tudo bem sobrevivente, se você tiver encontrado "+ ReqShroomsCount +" desses cogumelos trazê-los para o seguinte local. Espere um segundo...";
		m_MissionMessage2 = "Traga-os para o ** "+ m_MissionDescription[3] +" Escritório do Hospital **\n"+ SurvivorExtName +" disse que ela poderia extrair a substância ativa para mim. Ela tem uma pequena caixa protetora em sua mesa em seu antigo escritório.";
		m_MissionMessage3 = "Coloque tudo o que você encontrou lá. Tenha cuidado, pode haver bandidos por perto que possam interceptar nossa pequena conversa de rádio aqui. Boa sorte!";

class PlaneCrashMission extends SurvivorMissions
{
	...
	void PlaneCrashMission()
	{
        ...
        m_MissionMessage1 = "Acabei de receber uma ligação de emergência de um piloto militar. Um membro da tripulação foi infectado e de repente atacou outros. Ele disse que este vôo tem a maior prioridade internacional.";
        m_MissionMessage2 = "Também a bordo está o Sr. "+ SurvivorName +", ele é um agente da ONU e parece que tem algumas informações sobre a cura para esta doença pandêmica. Eles estavam no nível de vôo 300 a caminho do País de Gales.";
        m_MissionMessage3 = "O piloto disse que foi mordido e tentou aterrissar de emergência em algum lugar nos campos\n** "+ m_MissionLocationDir +" do "+ m_MissionLocation +" **\nDescubra se eles conseguiram. Eles têm algum equipamento a bordo!";		
